...
function ScheduledReports({
  ...
  const nextRunFormatted = "Sep 1, 2026";
  const lastRunFormatted = "Aug 1, 2026";
  ...
  return (
    <div style={{ marginBottom: 28 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
        ...
        <div style={{ ...reportStyles.card, position: "relative", padding: 22 }}>
          ...
          <div style={{ borderTop: "1px solid #f1f5f9", marginTop: 16, paddingTop: 14, display: "flex", gap: 24, fontSize: 12 }}>
            <div>
              <span style={{ color: "#94a3b8", display: "block", fontSize: 10, fontWeight: 700 }}>LAST RUN</span>
              <strong style={{ color: "#334155" }}>{lastRunFormatted}</strong>
            </div>
            <div>
              <span style={{ color: "#94a3b8", display: "block", fontSize: 10, fontWeight: 700 }}>NEXT RUN</span>
              <strong style={{ color: "#334155" }}>{nextRunFormatted}</strong>
            </div>
            <div>
              <span style={{ color: "#94a3b8", display: "block", fontSize: 10, fontWeight: 700 }}>STATUS</span>
